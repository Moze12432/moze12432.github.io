...
def create_excel_from_content(title, data):
    ...
    try:
        ...
        if isinstance(data, dict):
            df = pd.DataFrame(list(data.items()), columns=['Category', 'Information'])
...
def run_agent(query):
    ...
    if any(phrase in q for phrase in ["ppt about", "presentation about", "make a ppt", "create a ppt", "generate a ppt", "powerpoint about"]):
        ...
        with st.spinner(f"📊 Creating PowerPoint presentation about '{topic}'..."):
            content_prompt = f'Write detailed content for a PowerPoint presentation about "{topic}". Include a title slide, 5-7 content slides with bullet points, each slide with a clear heading and 3-5 bullet points, and a conclusion slide.'
    ...
    if any(phrase in q for phrase in ["excel about", "spreadsheet about", "csv about", "make an excel", "create an excel", "generate excel", "table about", "data about"]):
        ...
        with st.spinner(f"📊 Creating Excel spreadsheet about '{topic}'..."):
            content_prompt = f'Generate structured data about "{topic}" in a table format. Include categories and relevant information.'
