...
# ============================================
# IMPROVED IMAGE GENERATION WITH BETTER PROMPTS
# ============================================

def generate_image(prompt):
    """Generate an image with enhanced prompt engineering"""
    try:
        # Enhance the prompt with quality descriptors
        enhanced_prompt = f"{prompt}, high quality, detailed, well-proportioned, realistic, no distortions, clear features"
        
        # Negative prompt (what to avoid) - encode separately
        ...
        # Use Pollinations with negative prompt
...
def generate_image_with_quality(prompt, quality="high", style="realistic"):
    """Generate image with specific quality and style settings"""
    try:
        ...
        # Strong negative prompt to avoid bad generations
...
def generate_and_display_image(prompt, is_edit=False):
    """Generate and display image with quality improvements"""
    # Use enhanced generation
    image_url = generate_image_with_quality(prompt, quality="high", style="realistic")
    
    if image_url:
        if is_edit:
            return f"🎨 **Edited Image - New Prompt:** '{prompt}'\n\n![Generated Image]({image_url})\n\n*Image generated by AI - Results may vary. Try being more specific for better results.*"
        else:
            return f"🎨 **Generated Image for:** '{prompt}'\n\n![Generated Image]({image_url})\n\n*Image generated by AI - For best results, use detailed descriptions.*"
    else:
